...
# TODO Terminal usunąć zamienione na 1000
        ...
        try:
            ...
            if input == 'Q':
                    ...
                    try:
                        ...
                        if answer != '':
                            if len(suggestions) > 0 and not speller.check(answer):
                                if QuestionYesNo("Podane słowo nie znajduje się w słowniku. Czy pomimo to użyć go",
                                                 True, False):
                ...
                try:
                    ...
                    if answer != '':
                        if len(suggestions) > 0 and not speller.check(answer):
                            if QuestionYesNo("Podane słowo nie znajduje się w słowniku. Czy pomimo tego użyć go?", True,
                                             False):
